...
namespace NW26.TypedViewClasses
{
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalNamespaces
	// __LLBLGENPRO_USER_CODE_REGION_END
	
	
	/// <summary>Typed datatable for the view 'QuarterlyOrders'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class QuarterlyOrdersTypedView : TypedViewBase<QuarterlyOrdersRow>, ITypedView2
			...
			
	{
		...
		static QuarterlyOrdersTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public QuarterlyOrdersTypedView():base("QuarterlyOrders")
		{
			InitClass();
		}
#if !CF	
		...
		protected QuarterlyOrdersTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new QuarterlyOrdersRow(rowBuilder);
		}
		...
		protected override void InitClass()
		{
			...
			_fields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.QuarterlyOrdersTypedView);
		...
		{
			QuarterlyOrdersTypedView cloneToReturn = ((QuarterlyOrdersTypedView)(base.Clone()));
		...
		{
			return new QuarterlyOrdersTypedView();
		}
#endif
		...
		{
			get { return QuarterlyOrdersTypedView.CustomProperties;}
		}
		...
		{
			get { return QuarterlyOrdersTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable QuarterlyOrders</summary>
	public partial class QuarterlyOrdersRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END
			
	{
		#region Class Member Declarations
		private QuarterlyOrdersTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal QuarterlyOrdersRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((QuarterlyOrdersTypedView)(this.Table));
		}
