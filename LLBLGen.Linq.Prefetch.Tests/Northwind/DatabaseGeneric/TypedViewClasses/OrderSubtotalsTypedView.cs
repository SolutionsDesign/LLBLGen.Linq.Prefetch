...
namespace NW26.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'OrderSubtotals'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class OrderSubtotalsTypedView : TypedViewBase<OrderSubtotalsRow>, ITypedView2
			...
			
	{
		...
		static OrderSubtotalsTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public OrderSubtotalsTypedView():base("OrderSubtotals")
		{
			InitClass();
		}
#if !CF	
		...
		protected OrderSubtotalsTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new OrderSubtotalsRow(rowBuilder);
		}
		...
		protected override void InitClass()
		{
			...
			_fields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.OrderSubtotalsTypedView);
		...
		{
			OrderSubtotalsTypedView cloneToReturn = ((OrderSubtotalsTypedView)(base.Clone()));
		...
		{
			return new OrderSubtotalsTypedView();
		}
#endif
		...
		{
			get { return OrderSubtotalsTypedView.CustomProperties;}
		}
		...
		{
			get { return OrderSubtotalsTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable OrderSubtotals</summary>
	public partial class OrderSubtotalsRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END
			
	{
		#region Class Member Declarations
		private OrderSubtotalsTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal OrderSubtotalsRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((OrderSubtotalsTypedView)(this.Table));
		}
