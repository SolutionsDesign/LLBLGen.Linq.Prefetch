...
namespace NW26.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", NW26.RelationClasses.StaticEmployeesRelations.EmployeesEntityUsingEmployeeIdReportsToStatic, true, signalRelatedEntity, "Employees_", resetFKFields, new int[] { (int)EmployeesFieldIndex.ReportsTo } );
			_employees = null;
		}
		...
		private void SetupSyncEmployees(IEntity2 relatedEntity)
		{
			if(_employees!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", NW26.RelationClasses.StaticEmployeesRelations.EmployeesEntityUsingEmployeeIdReportsToStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoriesEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoriesEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)NW26.EntityType.EmployeesEntity, (int)NW26.EntityType.EmployeeTerritoriesEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrdersEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrdersEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)NW26.EntityType.EmployeesEntity, (int)NW26.EntityType.OrdersEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeesEntityFactory))),	(IEntityRelation)GetRelationsForField("Employees")[0], (int)NW26.EntityType.EmployeesEntity, (int)NW26.EntityType.EmployeesEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)NW26.EntityType.EmployeesEntity; }
		}
