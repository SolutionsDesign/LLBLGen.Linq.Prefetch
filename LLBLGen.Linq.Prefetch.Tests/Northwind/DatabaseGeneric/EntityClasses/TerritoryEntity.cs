...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _region, new PropertyChangedEventHandler(OnRegionPropertyChanged), "Region", "Territories", Northwind.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, new int[] { (int)TerritoryFieldIndex.RegionId });
		}
		...
		{
			SetupSync(relatedEntity, ref _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", "Territories", Northwind.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, new string[] {  }, new int[] { (int)TerritoryFieldIndex.RegionId }); 
		}
