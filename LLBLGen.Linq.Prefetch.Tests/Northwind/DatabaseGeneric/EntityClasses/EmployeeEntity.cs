...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "Employees", Northwind.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, true, new int[] { (int)EmployeeFieldIndex.ReportsTo });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "Employees", Northwind.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIdReportsToStatic, true, new string[] {  }, new int[] { (int)EmployeeFieldIndex.ReportsTo }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _region1, new PropertyChangedEventHandler(OnRegion1PropertyChanged), "Region1", "Employees", Northwind.RelationClasses.StaticEmployeeRelations.RegionEntityUsingRegionIdStatic, true, new int[] { (int)EmployeeFieldIndex.RegionId });
		}
		...
		{
			SetupSync(relatedEntity, ref _region1, new PropertyChangedEventHandler( OnRegion1PropertyChanged ), "Region1", "Employees", Northwind.RelationClasses.StaticEmployeeRelations.RegionEntityUsingRegionIdStatic, true, new string[] {  }, new int[] { (int)EmployeeFieldIndex.RegionId }); 
		}
