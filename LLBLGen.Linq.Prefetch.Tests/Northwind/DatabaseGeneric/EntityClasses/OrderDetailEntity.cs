...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _order, new PropertyChangedEventHandler(OnOrderPropertyChanged), "Order", "OrderDetails", Northwind.RelationClasses.StaticOrderDetailRelations.OrderEntityUsingOrderIdStatic, true, new int[] { (int)OrderDetailFieldIndex.OrderId });
		}
		...
		{
			SetupSync(relatedEntity, ref _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", "OrderDetails", Northwind.RelationClasses.StaticOrderDetailRelations.OrderEntityUsingOrderIdStatic, true, new string[] {  }, new int[] { (int)OrderDetailFieldIndex.OrderId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "OrderDetails", Northwind.RelationClasses.StaticOrderDetailRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)OrderDetailFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "OrderDetails", Northwind.RelationClasses.StaticOrderDetailRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)OrderDetailFieldIndex.ProductId }); 
		}
