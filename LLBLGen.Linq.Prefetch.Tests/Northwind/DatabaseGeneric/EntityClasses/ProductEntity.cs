...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _category, new PropertyChangedEventHandler(OnCategoryPropertyChanged), "Category", "Products", Northwind.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, new int[] { (int)ProductFieldIndex.CategoryId });
		}
		...
		{
			SetupSync(relatedEntity, ref _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", "Products", Northwind.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, new string[] {  }, new int[] { (int)ProductFieldIndex.CategoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _supplier, new PropertyChangedEventHandler(OnSupplierPropertyChanged), "Supplier", "Products", Northwind.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, new int[] { (int)ProductFieldIndex.SupplierId });
		}
		...
		{
			SetupSync(relatedEntity, ref _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", "Products", Northwind.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, new string[] {  }, new int[] { (int)ProductFieldIndex.SupplierId }); 
		}
