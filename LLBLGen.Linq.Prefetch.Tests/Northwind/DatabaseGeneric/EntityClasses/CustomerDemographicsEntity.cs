...
namespace NW26.EntityClasses
{
			...
			
	{
		...
		{
			get { return GetOrCreateEntityCollection<CustomerCustomerDemoEntity, CustomerCustomerDemoEntityFactory>("CustomerDemographics", true, false, ref _customerCustomerDemos);	}
		}
		...
		{ 
			get { return (int)NW26.EntityType.CustomerDemographicsEntity; }
		}
