...
namespace NW26.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductsEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)NW26.EntityType.CategoriesEntity, (int)NW26.EntityType.ProductsEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)NW26.EntityType.CategoriesEntity; }
		}
