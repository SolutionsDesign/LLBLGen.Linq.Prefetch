...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)Northwind.EntityType.SupplierEntity, (int)Northwind.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCategoryCollectionViaProduct
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))), intermediateRelation,
					(int)Northwind.EntityType.SupplierEntity, (int)Northwind.EntityType.CategoryEntity, 0, null, null, GetRelationsForField("CategoryCollectionViaProduct"), null, "CategoryCollectionViaProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{ 
			get { return (int)Northwind.EntityType.SupplierEntity; }
		}
