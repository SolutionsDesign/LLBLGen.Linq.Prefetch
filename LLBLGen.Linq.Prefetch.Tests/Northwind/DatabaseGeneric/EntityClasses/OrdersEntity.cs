...
namespace NW26.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private ShippersEntity _shippers;
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "Employees":
					...
					break;
				case "Shippers":
					this.Shippers = (ShippersEntity)entity;
					break;
				case "OrderDetails":
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Employees":
					...
					break;
				case "Shippers":
					toReturn.Add(Relations.ShippersEntityUsingShipVia);
					break;
				case "OrderDetails":
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'Shippers' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoShippers()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ShippersFields.ShipperId, null, ComparisonOperator.Equal, this.ShipVia));
			return bucket;
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customers, new PropertyChangedEventHandler( OnCustomersPropertyChanged ), "Customers", NW26.RelationClasses.StaticOrdersRelations.CustomersEntityUsingCustomerIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrdersFieldIndex.CustomerId } );
			_customers = null;
		}

		/// <summary> setups the sync logic for member _customers</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncCustomers(IEntity2 relatedEntity)
		{
			if(_customers!=relatedEntity)
			{
				DesetupSyncCustomers(true, true);
				_customers = (CustomersEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _customers, new PropertyChangedEventHandler( OnCustomersPropertyChanged ), "Customers", NW26.RelationClasses.StaticOrdersRelations.CustomersEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", NW26.RelationClasses.StaticOrdersRelations.EmployeesEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrdersFieldIndex.EmployeeId } );
			_employees = null;
		}

		/// <summary> setups the sync logic for member _employees</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncEmployees(IEntity2 relatedEntity)
		{
			if(_employees!=relatedEntity)
			{
				DesetupSyncEmployees(true, true);
				_employees = (EmployeesEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", NW26.RelationClasses.StaticOrdersRelations.EmployeesEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shippers, new PropertyChangedEventHandler( OnShippersPropertyChanged ), "Shippers", NW26.RelationClasses.StaticOrdersRelations.ShippersEntityUsingShipViaStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrdersFieldIndex.ShipVia } );
			_shippers = null;
		}

		/// <summary> setups the sync logic for member _shippers</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncShippers(IEntity2 relatedEntity)
		{
			if(_shippers!=relatedEntity)
			{
				DesetupSyncShippers(true, true);
				_shippers = (ShippersEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _shippers, new PropertyChangedEventHandler( OnShippersPropertyChanged ), "Shippers", NW26.RelationClasses.StaticOrdersRelations.ShippersEntityUsingShipViaStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomersEntityFactory))),	(IEntityRelation)GetRelationsForField("Customers")[0], (int)NW26.EntityType.OrdersEntity, (int)NW26.EntityType.CustomersEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeesEntityFactory))),	(IEntityRelation)GetRelationsForField("Employees")[0], (int)NW26.EntityType.OrdersEntity, (int)NW26.EntityType.EmployeesEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Shippers' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathShippers
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShippersEntityFactory))),	(IEntityRelation)GetRelationsForField("Shippers")[0], (int)NW26.EntityType.OrdersEntity, (int)NW26.EntityType.ShippersEntity, 0, null, null, null, null, "Shippers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> Gets / sets related entity of type 'ShippersEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(false)]
		public virtual ShippersEntity Shippers
		{
		...
		{ 
			get { return (int)NW26.EntityType.OrdersEntity; }
		}
