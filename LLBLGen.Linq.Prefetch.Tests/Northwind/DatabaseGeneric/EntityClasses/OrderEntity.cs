...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _customer, new PropertyChangedEventHandler(OnCustomerPropertyChanged), "Customer", "Orders", Northwind.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, new int[] { (int)OrderFieldIndex.CustomerId });
		}
		...
		{
			SetupSync(relatedEntity, ref _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", "Orders", Northwind.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  }, new int[] { (int)OrderFieldIndex.CustomerId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "Orders", Northwind.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new int[] { (int)OrderFieldIndex.EmployeeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "Orders", Northwind.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  }, new int[] { (int)OrderFieldIndex.EmployeeId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _shipper, new PropertyChangedEventHandler(OnShipperPropertyChanged), "Shipper", "Orders", Northwind.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, new int[] { (int)OrderFieldIndex.ShipVia });
		}
		...
		{
			SetupSync(relatedEntity, ref _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", "Orders", Northwind.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, new string[] {  }, new int[] { (int)OrderFieldIndex.ShipVia }); 
		}
