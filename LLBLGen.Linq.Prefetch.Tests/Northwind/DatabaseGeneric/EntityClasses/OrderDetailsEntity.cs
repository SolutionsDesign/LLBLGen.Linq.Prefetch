...
namespace NW26.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _orders, new PropertyChangedEventHandler( OnOrdersPropertyChanged ), "Orders", NW26.RelationClasses.StaticOrderDetailsRelations.OrdersEntityUsingOrderIdStatic, true, signalRelatedEntity, "OrderDetails", resetFKFields, new int[] { (int)OrderDetailsFieldIndex.OrderId } );
			_orders = null;
		}

		/// <summary> setups the sync logic for member _orders</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncOrders(IEntity2 relatedEntity)
		{
			if(_orders!=relatedEntity)
			{
				DesetupSyncOrders(true, true);
				_orders = (OrdersEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _orders, new PropertyChangedEventHandler( OnOrdersPropertyChanged ), "Orders", NW26.RelationClasses.StaticOrderDetailsRelations.OrdersEntityUsingOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncProducts(IEntity2 relatedEntity)
		{
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrdersEntityFactory))),	(IEntityRelation)GetRelationsForField("Orders")[0], (int)NW26.EntityType.OrderDetailsEntity, (int)NW26.EntityType.OrdersEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductsEntityFactory))),	(IEntityRelation)GetRelationsForField("Products")[0], (int)NW26.EntityType.OrderDetailsEntity, (int)NW26.EntityType.ProductsEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)NW26.EntityType.OrderDetailsEntity; }
		}
