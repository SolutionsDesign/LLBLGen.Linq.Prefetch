...
namespace Northwind.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "EmployeeTerritories", Northwind.RelationClasses.StaticEmployeeTerritoryRelations.EmployeeEntityUsingEmployeeIdStatic, true, new int[] { (int)EmployeeTerritoryFieldIndex.EmployeeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "EmployeeTerritories", Northwind.RelationClasses.StaticEmployeeTerritoryRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  }, new int[] { (int)EmployeeTerritoryFieldIndex.EmployeeId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _territory, new PropertyChangedEventHandler(OnTerritoryPropertyChanged), "Territory", "EmployeeTerritories", Northwind.RelationClasses.StaticEmployeeTerritoryRelations.TerritoryEntityUsingTerritoryIdStatic, true, new int[] { (int)EmployeeTerritoryFieldIndex.TerritoryId });
		}
		...
		{
			SetupSync(relatedEntity, ref _territory, new PropertyChangedEventHandler( OnTerritoryPropertyChanged ), "Territory", "EmployeeTerritories", Northwind.RelationClasses.StaticEmployeeTerritoryRelations.TerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)EmployeeTerritoryFieldIndex.TerritoryId }); 
		}
