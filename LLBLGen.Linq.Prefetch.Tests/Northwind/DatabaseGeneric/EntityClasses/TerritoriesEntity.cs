...
namespace NW26.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Territories'.<br/><br/></summary>
	[Serializable]
	public partial class TerritoriesEntity : CommonEntityBase
			...
			
	{
		...
		public TerritoriesEntity():base("TerritoriesEntity")
		{
		...
		public TerritoriesEntity(IEntityFields2 fields):base("TerritoriesEntity")
		{
		...
		public TerritoriesEntity(IValidator validator):base("TerritoriesEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="territoryId">PK value for Territories which data should be fetched into this Territories object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TerritoriesEntity(System.String territoryId):base("TerritoriesEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this TerritoriesEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TerritoriesEntity(System.String territoryId, IValidator validator):base("TerritoriesEntity")
		{
			InitClassEmpty(validator, null);
			this.TerritoryId = territoryId;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TerritoriesEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", NW26.RelationClasses.StaticTerritoriesRelations.RegionEntityUsingRegionIdStatic, true, signalRelatedEntity, "Territories", resetFKFields, new int[] { (int)TerritoriesFieldIndex.RegionId } );
			_region = null;
		}
		...
		private void SetupSyncRegion(IEntityCore relatedEntity)
		{
			if(_region!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", NW26.RelationClasses.StaticTerritoriesRelations.RegionEntityUsingRegionIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoriesEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoriesEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)NW26.EntityType.TerritoriesEntity, (int)NW26.EntityType.EmployeeTerritoriesEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RegionEntityFactory))),	(IEntityRelation)GetRelationsForField("Region")[0], (int)NW26.EntityType.TerritoriesEntity, (int)NW26.EntityType.RegionEntity, 0, null, null, null, null, "Region", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The RegionId property of the Entity Territories<br/><br/></summary>
		...
		public virtual System.Int32 RegionId
		{
			...
			set	{ SetValue((int)TerritoriesFieldIndex.RegionId, value); }
		}

		/// <summary> The TerritoryDescription property of the Entity Territories<br/><br/></summary>
		...
		public virtual System.String TerritoryDescription
		{
			...
			set	{ SetValue((int)TerritoriesFieldIndex.TerritoryDescription, value); }
		}

		/// <summary> The TerritoryId property of the Entity Territories<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)TerritoriesFieldIndex.TerritoryId, true); }
			set	{ SetValue((int)TerritoriesFieldIndex.TerritoryId, value); }
		}
		...
		{ 
			get { return (int)NW26.EntityType.TerritoriesEntity; }
		}
