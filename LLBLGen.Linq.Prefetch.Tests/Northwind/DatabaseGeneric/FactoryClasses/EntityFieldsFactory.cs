...
namespace NW26.FactoryClasses
{
	...
	{
		private static readonly Dictionary<NW26.EntityType, string> _entityTypeNamesCache = new Dictionary<NW26.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(NW26.EntityType value in Enum.GetValues(typeof(NW26.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(NW26.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(NW26.EntityType relatedEntityType)
		{
