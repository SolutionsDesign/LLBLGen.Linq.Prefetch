...
namespace Northwind.FactoryClasses
{
	...
	{
		private static readonly Dictionary<Northwind.EntityType, string> _entityTypeNamesCache = new Dictionary<Northwind.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(Northwind.EntityType value in Enum.GetValues(typeof(Northwind.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(Northwind.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(Northwind.EntityType relatedEntityType)
		{
